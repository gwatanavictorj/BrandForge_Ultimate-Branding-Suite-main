    ...
    <div className="min-h-screen bg-slate-50 flex overflow-x-hidden">
      ...
      <aside className={cn(
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4 px-4">Main Menu</div>
          {filteredSteps.map((step) => {
            ...
            return (
              <button
                ...
                disabled={isLocked}
                className={cn(
                  "w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all text-left group relative cursor-pointer",
                  isActive 
          ...
          <div className="pt-6 mt-6 border-t border-slate-100 space-y-1">
            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4 px-4">Data Management</div>
            <button
              onClick={() => exportProjects(projects)}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-slate-50 hover:text-slate-900 transition-all text-left group cursor-pointer"
            >
              <Download className="w-5 h-5 text-slate-400 group-hover:text-brand-500" />
              <span className="font-medium text-sm">Export Library</span>
            </button>
            <button
              onClick={() => fileInputRef.current?.click()}
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-500 hover:bg-slate-50 hover:text-slate-900 transition-all text-left group cursor-pointer"
            >
              <Upload className="w-5 h-5 text-slate-400 group-hover:text-brand-500" />
