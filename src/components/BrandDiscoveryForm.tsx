      ...
      {showCompleteModal && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-[110] p-4">
          <motion.div 
            ...
            className="bg-white rounded-[32px] p-8 max-w-md w-full shadow-2xl border border-slate-100 text-center space-y-6 relative"
          >
            <button 
            ...
            <div className="flex flex-col items-center gap-4 pt-4">
              <Button 
                ...
                size="md"
                className="w-full py-6 gap-3 label border-slate-200 group"
              >
              ...
              <button 
                ...
                className="mt-2 text-slate-400 hover:text-brand-600 font-bold text-xs uppercase tracking-widest transition-colors label"
              >
                Back to Dashboard
              </button>
            </div>
